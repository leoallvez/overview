 ...
 *
 * @param model The [CatalogUiModel] containing the data to be displayed.
    ...
    Card(
        ...
        Row(
            ...
            UiTitle(
                ...
                color = if (selected == true) HighlightColor else DefaultTextColor
            )
            rightContent()
        }
    }
