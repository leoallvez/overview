...
@Composable
private fun UiMediaTypeSelectorEnglishPreview() {
    UiMediaTypeSelectorPreviewHelper()
}

@Preview(name = "Portuguese", locale = "pt-rBR")
@Composable
private fun UiMediaTypeSelectorPortuguesePreview() {
    UiMediaTypeSelectorPreviewHelper()
}

@Preview(name = "Japanese", locale = "ja")
@Composable
private fun UiMediaTypeSelectorJapanesePreview() {
    UiMediaTypeSelectorPreviewHelper()
}

@Preview(name = "Spanish", locale = "es")
@Composable
private fun UiMediaTypeSelectorSpanishPreview() {
    UiMediaTypeSelectorPreviewHelper()
}
