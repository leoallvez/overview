...
class GetPersonDetailsByIdUseCaseTest {

    private lateinit var sut: IGetPersonDetailsByIdUseCase

    private lateinit var getter: GetById<PersonDetails>

    @Before
    fun setup() {
        getter = mockk()
        sut = GetPersonDetailsByIdUseCase(getter)
    }
